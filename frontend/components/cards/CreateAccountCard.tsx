...
const CreateAccountCard: FC<CreateAccountCardProps> = (props) => {
        ...
        <form className="w-full max-w-sm">
          ...
          <div>
            {accountNameStatus ? (
              ...
              <div className="pt-2">
                <button
                  className="w-full bg-gray-300 border-gray-300 text-sm border-4 text-gray-500 py-1 rounded cursor-not-allowed"
                  type="button"
                  disabled
                >
                  Create new account
